...
//     private analogousColor?: string;
//     private _baseColor?: string;
//     constructor(_baseColor?: string) {
//         let [complementary, analogous] = this.getComplementaryColors(_baseColor!)
//         this._baseColor = _baseColor;
//         this.complementaryColor = complementary;
//         this.analogousColor = analogous;
//     }
//     get baseColor(): string | undefined {
//         return this._baseColor;
//     }
//     get complementaryColorValue(): string | undefined {
//         return this.complementaryColor;
//     }
//     get analogousColorValue(): string | undefined {
//         return this.analogousColor;
//     }

//     getComplementaryColors(baseColor: string): [string, string] {
...
//         return [complementaryColor, analogousColor];
//     }
